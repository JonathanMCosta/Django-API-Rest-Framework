...
from .serializers import (
    EventoSerializer, ParticipanteSerializer, ParticipanteSerializerV2, 
    InscricaoSerializer, ListaInscricoesEventosSerializer, 
...
class ListaIncricoesParticipantes(generics.ListAPIView):    
...
class ListaInscricoesEventos(generics.ListAPIView):    
    serializer_class = ListaInscricoesEventosSerializer
