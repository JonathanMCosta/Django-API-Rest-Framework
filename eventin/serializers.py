...
class ParticipanteSerializer(serializers.ModelSerializer):
    ...
    def validate(self, dados):
        if nome_invalido(dados.get("nome", "")):
            raise serializers.ValidationError({"nome": "o nome deve ter pelo menos 3 caracteres e conter somente letras"})
...
class ListaInscricoesEventosSerializer(serializers.ModelSerializer):
